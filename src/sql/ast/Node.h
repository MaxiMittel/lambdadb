...
public:
    ...
    virtual bool evaluateExpression(std::vector<std::shared_ptr<db::DataEntry>> const& entry) = 0;
};
...
public:
    ...
    bool evaluateExpression(std::vector<std::shared_ptr<db::DataEntry>> const& entry) override;
};
