          ...
          phases: {
            install: {
              commands: [
                ...
                "yum update -y",
                "yum install https://rpmfind.net/linux/fedora/linux/development/rawhide/Everything/x86_64/os/Packages/l/libstdc++-12.2.1-4.fc38.x86_64.rpm",
                "yum install https://rpmfind.net/linux/mageia/distrib/8/x86_64/media/core/updates/gcc-10.4.0-3.mga8.x86_64.rpm",
                "gcc --version",
